...
def get_dataset(is_train, args):
    ...
    class_map = {'proba_2':0, 'cheops':1, 'debris':2, 'double_star':3, 'earth_observation_sat_1':4,
                 'lisa_pathfinder':5, 'proba_3_csc' :6, 'proba_3_ocs':7, 'smart_1':8, 'soho':9, 'xmm_newton':10}
    num_classes = len(class_map)
    ds = PyTorchSparkDatasetV2(class_map, split=split, root_dir=args.data_path, transform=get_transform(is_train, args))
    return ds, num_classes
